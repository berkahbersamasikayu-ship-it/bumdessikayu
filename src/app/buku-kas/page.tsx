        ...
        <div className="flex flex-wrap items-end gap-4">
          <div>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="h-11 w-50 rounded-lg border border-gray-300 px-3 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-900 cursor-pointer"
              />
          ...
          <div>
            ...
            <select
              ...
              className="w-50 h-11 rounded-lg border border-gray-300 px-3 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-900"
            >
